 ...
 *  net.minecraft.server.v1_7_R4.EnumProtocol
 */
...
public class ReflectionConstants {
    ...
    public static final Class<Object> GAME_PROFILE_CLASS = ReflectionConstants.getUntypedClasses("net.minecraft.util.com.mojang.authlib.GameProfile", "com.mojang.authlib.GameProfile");
    ...
    public static Class<Object> getUntypedClasses(String ... lookupNames) {
        ...
        String[] arrstring = lookupNames;
        int n = arrstring.length;
        int n2 = 0;
        while (n2 < n) {
            String lookupName = arrstring[n2];
            try {
